...
namespace HEROsMod
{
	internal static class ModUtils
	{
        ...
        public static string SteamID => (string)_steamid.GetValue(null, null);
        ...
        /// </summary>
        public static bool SSC => Main.ServerSideCharacter;
        ...
        public static void SetDeltaTime(/*GameTime gameTime*/) => _deltaTime = 1f / 60f;// (float)gameTime.ElapsedGameTime.TotalSeconds;

        public static void SetDeltaTime(float deltaTime) => _deltaTime = deltaTime;
        ...
        public static Vector2 CursorTileCoords => GetTileCoordsFromWorldCoords(GetCursorWorldCoords());

        public static Vector2 GetCursorWorldCoords() => new Vector2((int)Main.screenPosition.X + Main.mouseX, (int)Main.screenPosition.Y + Main.mouseY);
